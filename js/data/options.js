...
(function () {
  ...
  /* ★ 차례 = **자주 고르는 사람이 앞** (2026-08-26 · 선생님 말씀).
       한 쪽에 여섯이라 **여섯씩 한 묶음**으로 넘어갑니다. 갈래끼리 묶어 두면
       학생이 「몇 쪽에 있더라」를 몸으로 익힙니다.
         1쪽  학교·집 : 선생님 · 친구 · 혼자 · 가족 · 엄마 · 아빠
         2쪽  형제자매 : 누나 · 형 · 언니 · 오빠 · 동생
         3쪽  친척     : 할머니 · 할아버지 · 삼촌 · 고모 · 이모
     ⛔ 이 차례를 바꾸지 마세요 — 첫 화면에 보이는 사람이 달라져 학생이
        늘 넘겨서 찾아야 하고, 쪽 나누기도 흐트러져 갈래가 섞입니다. */
  D.partners = [
    ...
    /* ★ 손위 형제는 **부르는 이름이 넷**입니다 (2026-08-24 · 선생님 말씀).
       ...
       ⛔ 「누나(언니)」 처럼 묶어 적지 마세요. 그대로 문장에 들어가면
          「나는 누나(언니)와 함께…」 가 됩니다.
       ▸ 2쪽에 **형제자매**가 옵니다 (2026-08-26 · 선생님 말씀) — 집에서
         여가를 함께하는 일이 할머니·삼촌보다 잦습니다. */
  ...
  /* ★ 차례 = **자주 가는 곳이 앞** (2026-08-26 · 선생님 말씀).
       한 쪽에 여섯이라 **여섯씩 한 묶음**으로 넘어갑니다. 그래서 갈래끼리
       묶어 두면 학생이 「몇 쪽에 있더라」를 몸으로 익힙니다.
         1쪽  학교 안 : 학교 · 교실 · 운동장 · 강당 · 학교 화단 · 텃밭
         2쪽  집·동네 : 집 · 부엌 · 놀이터 · 공원 · 동네 · 노래방
         3쪽  나들이  : 문구점 · 음식점 · 카페 · 캠핑장 · 도서관 · 영화관
         4쪽           미술관 · 박물관
     ⛔ 차례를 바꾸면 쪽 나누기가 흐트러져 갈래가 섞입니다. 더할 곳이 있으면
        **그 갈래의 끝**에 넣으세요.
     ▸ **부엌은 집 바로 뒤**입니다 (2026-08-26 · 선생님 말씀) — 부엌은 집의
       한 곳이라, 떨어뜨려 놓으면 학생이 다른 갈래로 여깁니다.
     ▸ 그림 파일 이름과 **똑같은 이름**을 씁니다 (`images/장소/교실.png`). */
  D.places = [
    '학교', '교실', '운동장', '강당', '학교 화단', '텃밭',
    '집', '부엌', '놀이터', '공원', '동네', '노래방',
    '문구점', '음식점', '카페', '캠핑장', '도서관', '영화관',
    '미술관', '박물관'
  ];
