...
(function () {
  ...
  D.agains = [
    ...
    /* ★ 단추 글씨와 일기 문장을 **같은 말**로 맞췄습니다.
         예전 `다음에는 다른 활동을 하고 싶어요` 는 단추에 두 줄로 접혔고,
         단추와 문장이 다르면 학생이 헷갈립니다.
         그림 파일 이름도 이 말을 그대로 따릅니다 —
         `images/또하기/다른 활동으로 하고 싶어요.png` */
    { id: 'other',  name: '다른 활동으로 하고 싶어요',      sentence: '다른 활동으로 하고 싶어요',             icon: 'star' },
