  ...
  var Speech = {
    ...
    speak: function (text, opts) {
      ...
      try {
        ...
        /* ⛔⛔ **읽는 빠르기는 1.0 입니다** (2026-08-30 · 선생님이 여러 번 :
             「스피커로 말하는 목소리를 고 문구마켓에서 읽어주는 목소리와
              동일했으면 해」 「스피커 목소리도 바꿔주고 제발」).

           ★ 목소리 **이름을 같게 골라도 소리가 달랐던 진짜 까닭**입니다.
             이 앱만 0.94 배로 **느리게** 읽고 있었습니다. 다른 앱들은
             기본값 1.0 을 씁니다. 빠르기가 다르면 같은 목소리라도
             음높이와 말맛이 달라져 **다른 목소리처럼 들립니다.**
           ▸ 목소리 자체는 기기가 가진 것이라 코드로 못 바꿉니다.
             선생님이 기기마다 고르시고(선생님 설정 5번), 빠르기는 여기서
             모든 기기가 같게 맞춥니다.
           ⚠ 예전 값 0.94 는 「천천히 읽어 주면 좋겠다」는 뜻이었습니다.
             학생에게 느린 편이 나으면 이 값을 되돌리면 됩니다 —
             다만 그러면 고문구마켓과 다시 달라집니다. */
