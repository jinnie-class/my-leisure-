...
(function () {
  ...
  C.DiaryScreen = function (p) {
    ...
    return html`<div class="app" data-corner="diary">
      ...
      <!-- ★★★ **여가 일기도 좌우 쪽으로 나누지 않습니다** (2026-09-04 · 재어서 찾음).
             1366x768(교실 노트북)에서 **1단계 여섯 화면**이 갈라져 있었습니다 —
             누구와 · 어디에서 · 기분 · 제목 · 또 하고 싶나 · 그림 고르기.
             1쪽에는 질문만 남고 카드 셋이 통째로 2·3쪽으로 밀려나서,
               「1 / 3」 인데 고를 것이 **한 장도 없는** 화면이 됐습니다.
           까닭은 계획하기와 같습니다 — 다단은 줄이기(zoom) 전 높이로 쪽을
           가릅니다 (plan.js 의 같은 자리 주석을 보세요).
         ▸ 일기도 카드를 제 손으로 세 장씩 넘기므로(arrowPager) 흰 칸까지
           또 나눌 까닭이 없습니다. 넘치면 줄여서 한 쪽에 담습니다.
         ⛔ isConfirm 으로 되돌리지 마세요 — 완성 화면만 막고 있어서
            정작 고르는 화면들이 갈라졌습니다. -->
