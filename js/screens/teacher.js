        ...
        <div class="panel tpanel">
          <div class="tscroll">
            ...
            <div class="row" style=${{ marginBottom: '.6rem' }}>
              ...
              <!-- ★★ **사용설명서를 「선생님 설정」 줄 옆에** (2026-09-02 · 선생님 말씀 —
                     「사용설명서를 선생님 설정 줄에 넣어서 PDF 파일로 다운받거나
                      인쇄할 수 있게 해 줘」 · 「선생님 설정줄 옆으로」).
                   설정 목록 안에 두면 아래로 한참 내려야 나옵니다. 제목 줄에 두면
                   설정을 열자마자 보입니다.
                 ▸ 새 탭에서 PDF 가 열립니다 — 그 창에서 **저장도 인쇄도** 됩니다.
                   (기기에 따라 바로 내려받기도 합니다)
                 ⛔ 주소에 한글과 괄호가 있어 encodeURI 로 감싸야 합니다 —
                    그냥 넘기면 기기에 따라 파일을 못 찾습니다.
                 ⛔⛔ 스크립트로 창을 여는 것이 아니라 **링크(a)** 입니다 — 태블릿 브라우저는
                    스크립트로 여는 창을 팝업으로 보고 막는 일이 있습니다.
                    링크는 막히지 않습니다. 생김새만 단추(btn small)로 맞춥니다.
                 ⚠ 설명서 파일은 **앱과 같은 폴더**에 있습니다. 앱만 따로 옮기면
                    이 단추가 파일을 못 찾습니다 (폴더째 옮기세요). -->
              <a class="btn small" target="_blank" rel="noopener"
                href=${encodeURI('나의여가_사용설명서(교사용).pdf')}
                title="새 탭에서 열립니다 — 그 창에서 저장하거나 인쇄하세요">
                <span class="ico" aria-hidden="true"
                  dangerouslySetInnerHTML=${{ __html: App.icon('book') }} />
                <span>사용설명서</span>
              </a>
