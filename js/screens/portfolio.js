  ...
  C.PortfolioScreen = function (p) {
    ...
    return html`<div class="app" data-corner="portfolio">
      ...
      <!-- ★ **상자는 첫 화면에만** (2026-08-29 · 선생님 말씀 —
         ...
         ▸ 칸에 들어간 뒤 : 대개 내용이 이미 폭을 다 씁니다. 그때 상자는
           아무것도 묶어 주지 못하고 테두리만 하나 더 그립니다 — 그래서 벗깁니다.
         ⛔ 이것은 화면마다 취향으로 정하는 것이 아니라 **내용이 폭을 다 쓰는가**
           로 정합니다. 새 칸을 더할 때도 그 잣대로 보세요.
         ★★ **나의 한마디 · 돌아보기는 상자를 다시 씌웁니다** (2026-08-30).
           선생님 : 「상자가 없어지니 좀 이상한 것 같은데」 → 재어서 확인했습니다.
           상자를 켰다 껐다 하며 같은 화면을 재니 **전부 같았습니다** —
             흰 칸 1251x458 · 줄이기 0.94 · 위 바 927x149 · 아래 바 927x192
             카드 200x55 · 그림 70px · 글자 14.45px
           bare 는 테두리·그림자·바탕만 지울 뿐 **자리를 내놓지 않습니다.**
           얻은 것 없이 「여기까지가 한 묶음」이라는 표시만 잃었습니다.
           ▸ 게다가 이 칸의 바는 흰 칸의 **74%(927/1251)** 만 씁니다.
