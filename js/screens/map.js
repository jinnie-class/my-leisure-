...
(function () {
  ...
  C.MyMapScreen = function (p) {
    ...
    return html`<div class="app" data-corner="map">
      ...
      <!-- 되짚는 길(한 걸음씩)은 맨 위 파란 화살표와 왼쪽 알약이 맡습니다.
           ★ 맨 아래 노란 단추는 **되짚는 길이 아니라 나가는 길**입니다.
             여기까지 왔으면 이 코너에서 할 일이 끝난 자리라, 한 걸음씩
             되짚지 않고 **바로 나의 여가로** 갑니다.
             계획하GO! 의 마지막 화면과 **같은 모양 · 같은 자리**로 두었습니다. -->
      <${C.Stage} action=${html`<${C.Btn} icon="home" className="pastel-yellow"
